...
<div class="linkbox">
  <a href="http://marine.weathersa.co.za" target="_blank">WeatherSA<small>Have a look at their website</small></a>
</div>

<hr>
<h2>Position Estimation using Stereoscopic Images</h2>
<p class="subtitle">2019</p>
<p>
  The aim of this project was to develop a neural network capable of predicting the position (x,y,z) of fingertips in a pair of stereoscopic images. These images were obtained from a Leap Motion Controller, using their API to create a custom labeled dataset. Each pair of images was annotated with the coordinated of each of the features to be tracked. Have a look at the links below for more information.
</p>
<div class="linkbox">
  <div class="innerleft">
